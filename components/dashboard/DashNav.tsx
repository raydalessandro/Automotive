...
export function DashNav({ email }: { email: string | null }) {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-nero/10 bg-avorio/95 backdrop-blur">
      <div className="mx-auto flex max-w-[92rem] items-center justify-between gap-4 px-4 py-3 sm:px-6 lg:px-10">
      ...
      <nav className="mx-auto max-w-[92rem] overflow-x-auto px-4 sm:px-6 lg:px-10">
